...
function App() {
  ...
  useEffect(async ()=>{
    ...
    const Deposit = await blockchain.stakingContract.methods.
    depositsOf(blockchain.account)
    .call();
    setDeposits(Deposit);
    }
    else{
    setDeposits("Connect WalletPlease")
    }
  })
  ...
  return (
    <s.Screen>
      ...
      >
        <a href= "https://metamonstas.com">
        <StyledLogo 
             alt={"logo"} src={"/config/images/logo512.png"} /></a>
        <s.SpacerLarge/>
        ...
        <ResponsiveWrapper>
        <s.TextTitle>
                  You have to Approve Staking Once before staking your NFTs.
                </s.TextTitle>
        </ResponsiveWrapper>
        <s.SpacerSmall/>
        <ResponsiveWrapper>
        <StyledButton
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <a href = "https://mint.metamonstas.com/">
        <StyledButton>
                   To Mint Page
                  </StyledButton></a>
        </ResponsiveWrapper>
